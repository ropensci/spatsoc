...
cols <- c('iteration', 'yr')
iterYearLs <- randStep[!(observed), do.call(unique, list(x = .SD)), .SDcols = cols]
...
iterYearLs <- randDaily[!(observed), do.call(unique, list(x = .SD)), .SDcols = cols]
...
## Create a data.table of unique combinations of iteration and year
cols <- c('iteration', 'yr')
iterYearLs <- randTraj[!(observed), do.call(unique, list(x = .SD)), .SDcols = cols]
