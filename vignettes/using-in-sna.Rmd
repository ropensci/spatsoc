...
gbiLs <- mapply(FUN = function(i, y) {
  get_gbi(randStep[!(observed) & iteration == i & yr == y],
          'group', 'randomID')
  },
  i = iterYearLs$iter,
  y = iterYearLs$yr
...
gbiLs <- mapply(FUN = function(i, y, p) {
  get_gbi(randDaily[!(observed) & iteration == i & 
                      yr == y & population == p],
          'group', 'randomID')
  },
  i = iterYearLs$iter,
...
gbiLs <- mapply(FUN = function(i, y) {
  get_gbi(randTraj[!(observed) & iteration == i & yr == y],
          'group', 'ID')
  },
  i = iterYearLs$iter,
  y = iterYearLs$yr
...
<!-- Note: the observed data is included? -->
