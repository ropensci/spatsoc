...
# Grouping functions
spatsoc provides users with one temporal (`group_times`) and three spatial (`group_pts`, `group_lines`, `group_polys`) functions. Users can consider spatial grouping at 3 different scales combined with an appropriate temporal grouping threshold. 
