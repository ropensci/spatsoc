...
See the vignette about [using spatsoc in social network analysis!](https://cran.r-project.org/package=spatsoc/vignettes/using-in-sna.html)
...
**See the vignette [Using spatsoc in social network analysis](https://cran.r-project.org/package=spatsoc/vignettes/using-in-sna.html) for details about the `randomizations` function (specifically the section 'Data stream randomization')**
