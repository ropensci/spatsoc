...
| day            | "block", "minday", "maxday" columns added identifying the multiday block for each row. "block" refers to the specific multiday block, defined by the minimum day "minday" and maximum day "maxday".          |
