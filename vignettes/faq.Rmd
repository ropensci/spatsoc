...
**See the vignette [Using spatsoc in social network analysis - edge list generating functions](http://spatsoc.gitlab.io/articles/using-edge.html) for details about the `edge_dist` function.**
...
**See the vignette [Using spatsoc in social network analysis - edge list generating functions](http://spatsoc.gitlab.io/articles/using-edge.html) for details about the `edge_nn` function.**
