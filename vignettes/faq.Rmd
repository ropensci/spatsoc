...
**See the vignette [Using edge list generating functions and dyad_id](https://docs.ropensci.org/spatsoc/articles/using-edge.html) for details about the `edge_dist` function.**
...
**See the vignette [Using spatsoc in social network analysis - edge list generating functions](https://docs.ropensci.org/spatsoc/articles/using-edge.html) for details about the `edge_nn` function.**
