---
title: "Detecting interspecific interactions"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Detecting interspecific interactions}
...
Interspecific data can be used with `spatsoc` to estimate eg. predator-prey
dyanmics.
