...
g4 <- ggplot() + 
  ...
  theme(axis.title=element_blank(), axis.text=element_blank(), 
        axis.ticks=element_blank()) + 
  labs(color = 'Group') + 
  scale_color_manual(values = c('1' = '#b5b3b8', '2' = '#fb9a99'))
...
g6 <- ggplot(hr) + 
  ...
  theme(axis.title=element_blank(), axis.text=element_blank(), 
        axis.ticks=element_blank()) + 
  scale_fill_manual(values = c('1' = '#b5b3b8', '2' = '#fb9a99'))
...
GroupLines(locs, bufferWidth = 50, timeField = 'datetime', timeThreshold = '1 day', projection = '+proj=utm +zone=21 ellps=WGS84', coordFields = c('EASTING', 'NORTHING'), 
           idField = 'ID')
```
