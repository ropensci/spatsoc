...
pt.grps <- group_pts(sublocs, id = 'ID', threshold = 50,
                    projection = utm, datetime = 'datetime',
...
l <- group_lines(sublocs, projection = utm, datetime = 'day')
l[, groupN := .N, by = group]
...
group_lines(locs, bufferWidth = 50, datetime = 'datetime', threshold = '1 day', projection = '+proj=utm +zone=21 ellps=WGS84', coords = c('EASTING', 'NORTHING'), id = 'ID')
```

```{r grouplines, echo = FALSE}
pander::pander(
  group_lines(locs, bufferWidth = 50, datetime = 'datetime', threshold = '1 day', projection = '+proj=utm +zone=21 ellps=WGS84', coords = c('EASTING', 'NORTHING'),
           id = 'ID')[59:65])
```
