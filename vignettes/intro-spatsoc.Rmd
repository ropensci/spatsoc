...
pt.grps <- group_pts(sublocs, idField = 'ID', threshold = 50,
...
group_lines(locs, bufferWidth = 50, timeField = 'datetime', threshold = '1 day', projection = '+proj=utm +zone=21 ellps=WGS84', coordFields = c('EASTING', 'NORTHING'), idField = 'ID')
```
