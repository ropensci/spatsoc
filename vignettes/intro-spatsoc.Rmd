...
pt.grpsgroup_pts(locs, threshold =50, id = 'ID', coords = c('EASTING', 'NORTHING'))
...
group_pts(locs, threshold =50, id = 'ID', coords = c('EASTING', 'NORTHING'))
```

```{r fakegrouppts, echo=FALSE, eval = FALSE}
pander::pander(
  group_pts(locs, threshold =50, id = 'ID', coords = c('EASTING', 'NORTHING'))[388:395])
```
...
utm <- '+proj=utm +zone=21 ellps=WGS84'
group_lines(locs, threshold =50, projection = utm, id = 'ID', coords = c('EASTING', 'NORTHING'))
```

```{r grouplines, echo = FALSE, eval = FALSE}
pander::pander(
  group_lines(locs, threshold =50, projection = utm, id = 'ID', coords = c('EASTING', 'NORTHING'))[59:65])
```
