...
group_lines(locs, bufferWidth = 50, timeField = 'datetime', threshold = '1 day', projection = '+proj=utm +zone=21 ellps=WGS84', coords = c('EASTING', 'NORTHING'), id = 'ID')
```

```{r grouplines, echo = FALSE}
pander::pander(
  group_lines(locs, bufferWidth = 50, timeField = 'datetime', threshold = '1 day', projection = '+proj=utm +zone=21 ellps=WGS84', coords = c('EASTING', 'NORTHING'),
           id = 'ID')[59:65])
```
