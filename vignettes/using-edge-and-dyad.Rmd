...
`spatsoc` can be used in social network analysis to generate edge-lists from GPS relocation data. Distance based edge-lists are generated using either the `edge_dist` or the `edge_nn` function. 
