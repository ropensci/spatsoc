...
#'
#' If provided, the \code{threshold} must be provided in the units of the
#' coordinates and must be larger than 0. If the \code{threshold} is NULL, the
#' distance to all other individuals will be returned. The coordinates must be
#' planar coordinates (e.g.: UTM). In the case of UTM, a \code{threshold} = 50
#' would indicate a 50m distance threshold.
#'
...
#' \code{edge_dist}. If you have already calculated temporal groups without
