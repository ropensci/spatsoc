...
#' generated by edge_dist, a \code{data.table} with relocation data, individual
#' identifiers and a window argument. The window argument is used to specify the
#' temporal window within which to measure the directional correlation delay.
