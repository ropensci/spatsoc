...
#' handling coordinate reference systems, see more at
...
#' columns.
#'
#' The `crs` argument expects a numeric or character defining the coordinate
#' reference system. For example, for UTM zone 36N (EPSG 32736), the crs
#' argument is either `crs = 'EPSG:32736'` or `crs = 32736`. See details in
#' [`sf::st_crs()`] and <https://spatialreference.org> for a list of EPSG codes.
#'
