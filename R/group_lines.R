...
#'
#' The \code{id}, \code{coords} (and optionally \code{timegroup} and \code{splitBy}) arguments expect the names of respective columns in \code{DT} which correspond to the individual identifier, latitude and longitude, timegroup (generated by \code{group_times}) and additional grouping columns.
#'
