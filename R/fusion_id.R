#' Fission-fusion id
#'
#' `fusion_id` identifies fusion events in distance based edge-lists.
...
#'   `fusionID` column.
#'
#'   This column represents the fusion event id. As with `spatsoc`'s
...
#'   the `fusionID` may change, but the membership of each fusion event
#'   would not.
#'
